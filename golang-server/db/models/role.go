...
type Role struct {
	...
	Functionname null.String `boil:"functionname" json:"functionname,omitempty" toml:"functionname" yaml:"functionname,omitempty"`
	Camp         null.String `boil:"camp" json:"camp,omitempty" toml:"camp" yaml:"camp,omitempty"`
...
var RoleWhere = struct {
	...
	Functionname whereHelpernull_String
	Camp         whereHelpernull_String
}{
	Name:         whereHelperstring{field: "\"role\".\"name\""},
	ID:           whereHelpernull_Int{field: "\"role\".\"id\""},
	Number:       whereHelpernull_Int{field: "\"role\".\"number\""},
	Functionname: whereHelpernull_String{field: "\"role\".\"functionname\""},
	Camp:         whereHelpernull_String{field: "\"role\".\"camp\""},
}
...
var (
	roleAllColumns            = []string{"name", "id", "number", "functionname", "camp"}
	roleColumnsWithoutDefault = []string{"name"}
	roleColumnsWithDefault    = []string{"id", "number", "functionname", "camp"}
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, name string, selectCols ...string) (*Role, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"role\" where \"name\"=$1", sel,
	)
...
func (o *Role) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"role\" WHERE \"name\"=$1"
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, name string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"role\" where \"name\"=$1 limit 1)"
...
func (o *Role) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return RoleExists(ctx, exec, o.Name)
}
